...
interface MarkdownEditorProps {
  ...
  onSave: (frontmatter: Record<string, unknown>, content: string) => void;
  onCancel: () => void;
...
export function MarkdownEditor({
  ...
  }, [title, excerpt, author, featuredImage, tags, published, content]);
  ...
  const handleSave = useCallback(() => {
    ...
    const frontmatter: Record<string, unknown> = {
      ...
      publishedAt: initialFrontmatter?.publishedAt || new Date().toISOString(),
  ...
  }, [title, excerpt, author, tags, featuredImage, published, telegramDiscussion, content, initialFrontmatter, onSave, t]);
    ...
    <div className="flex flex-col h-full max-h-[calc(95vh-120px)] min-h-[500px]">
      ...
      <div className="border-b p-4 space-y-4">
        ...
        <div className="space-y-2">
          ...
          {/* Author, Tags, Featured Image - stacked */}
          <div className="grid grid-cols-1 gap-2">
            ...
            {/* Telegram Comments Row */}
            <div className="space-y-1">
              <Label className="text-xs text-muted-foreground">{t('Telegram Discussion URL')}</Label>
              <Input
