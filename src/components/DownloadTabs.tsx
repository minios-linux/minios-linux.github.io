                  ...
                  <div className="tab-bottom-section">
                    <div className="specs">
                      <div className="spec-item">
                        ...
                        <span className="spec-val">{edition.cpu || '1 GHz'}</span>
                        <span className="spec-label">{t(edition.requirements || 'CPU x64')}</span>
                      </div>
                      <div className="spec-item">
                        <MemoryStick className="spec-icon" />
                        <span className="spec-val">{edition.ram || '768 MB'}</span>
                        <span className="spec-label">{t(labels.ramLabel)}</span>
                      </div>
                      <div className="spec-item">
                        <HardDrive className="spec-icon" />
                        <span className="spec-val">{edition.size}</span>
