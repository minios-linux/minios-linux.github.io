...
const Header: React.FC<HeaderProps> = () => {
  ...
  return (
    <>
      ...
      <div className={`mobile-overlay ${mobileMenuOpen || (window.innerWidth <= 1100 && langMenuOpen) ? 'active' : ''}`} onClick={() => { closeMobileMenu(); setLangMenuOpen(false); }}></div>
      ...
      <nav className={`mobile-lang-menu ${langMenuOpen && window.innerWidth <= 1100 ? 'active' : ''}`}>
